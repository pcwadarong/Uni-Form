...
import { useSaveSurvey } from "@/features/survey/create/hooks/useSaveSurvey";
...
const CheckModal: React.FC<Props> = ({ onClose }) => {
  ...
  return (
    <dialog className="fixed inset-0 z-50 flex items-center justify-center" aria-modal="true">
      ...
      />
      <div
        className="relative z-50 flex max-h-full w-full max-w-150 flex-col gap-4 overflow-auto rounded-2xl bg-content p-5 shadow-2xl md:p-30px md:pt-35px"
        ref={modalRef}
      >
        <Select
