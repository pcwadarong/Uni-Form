  ...
  return (
    ...
    >
      ...
      <div
        ...
        ref={modalRef}
      >
        <Select onValueChange={handleMainCategoryChange} onOpenChange={() => setIsSelectOpen(true)}>
        ...
        {selectedMainCategory && (
          <Select
            ...
            onOpenChange={() => setIsSelectOpen(true)}
          >
            <SelectTrigger className="border-gray-2 mb-3">
        ...
        <div className="mt-5 gap-2 flex justify-center">
          ...
          />
          <Button text={'저장하기'} className={'bg-primary text-white'} onClick={handleOnClose} />
        </div>
      </div>
    </div>
  );
