...
//                     <li
//                       key={comment.id}
//                       className="w-full p-3 rounded-xl mb-2 border-[1px] border-gray-2 bg-content"
//                     >
...
//                 </ul>
//               ) : (
//                 <div className="h-52 border-[1px] border-gray-2 bg-content rounded-xl text-gray-3 flex flex-col gap-3 justify-center items-center">
